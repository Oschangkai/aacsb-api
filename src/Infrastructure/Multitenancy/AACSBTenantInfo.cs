...
public class AACSBTenantInfo : ITenantInfo
{
    public AACSBTenantInfo()
    {
    }

    public AACSBTenantInfo(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
    {
        Id = id;
        Identifier = id;
        Name = name;

...
internal static class Startup
{
    internal static IServiceCollection AddMultitenancy(this IServiceCollection services, IConfiguration config)
    {
        return services
            ...
            .AddMultiTenant<AACSBTenantInfo>()
                .WithClaimStrategy(AACSBClaims.Tenant)
                .WithHeaderStrategy(MultitenancyConstants.TenantIdName)
                .WithQueryStringStrategy(MultitenancyConstants.TenantIdName)
                .WithEFCoreStore<TenantDbContext, AACSBTenantInfo>()
                .Services
    ...
    private static FinbuckleMultiTenantBuilder<AACSBTenantInfo> WithQueryStringStrategy(this FinbuckleMultiTenantBuilder<AACSBTenantInfo> builder, string queryStringKey) =>

using AACSB.WebApi.Application.Catalog.Products;
...
{
    [HttpPost("search")]
    [MustHavePermission(AACSBAction.Search, AACSBResource.Products)]
    ...
    [HttpGet("{id:guid}")]
    [MustHavePermission(AACSBAction.View, AACSBResource.Products)]
    ...
    [HttpPost]
    [MustHavePermission(AACSBAction.Create, AACSBResource.Products)]
    ...
    [HttpPut("{id:guid}")]
    [MustHavePermission(AACSBAction.Update, AACSBResource.Products)]
    ...
    [HttpDelete("{id:guid}")]
    [MustHavePermission(AACSBAction.Delete, AACSBResource.Products)]
    ...
    [HttpPost("export")]
    [MustHavePermission(AACSBAction.Export, AACSBResource.Products)]
